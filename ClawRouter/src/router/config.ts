...
export const DEFAULT_ROUTING_CONFIG: RoutingConfig = {
  ...
  // TokenBoss fork: tiers rewritten to only use models available in our newapi
  // aggregator (anthropic/claude-haiku-4.5 and anthropic/claude-opus-4.6).
  // Simple/medium routes to haiku for cost; complex/reasoning routes to opus
  // for quality. Adjust here when more channels are added upstream.
  tiers: {
    SIMPLE: {
  ...
  // TokenBoss fork: eco collapses to haiku (the cheapest Claude we carry).
  ecoTiers: {
    SIMPLE: { primary: "anthropic/claude-haiku-4.5", fallback: [] },
    MEDIUM: { primary: "anthropic/claude-haiku-4.5", fallback: [] },
    COMPLEX: {
      primary: "anthropic/claude-haiku-4.5",
      fallback: ["anthropic/claude-opus-4.6"],
    },
  ...
  // TokenBoss fork: premium always goes opus first (best Claude we carry).
  premiumTiers: {
    SIMPLE: {
      primary: "anthropic/claude-opus-4.6",
      fallback: ["anthropic/claude-haiku-4.5"],
  ...
  // TokenBoss fork: agentic uses haiku for simple tool calls, opus for complex.
  agenticTiers: {
    SIMPLE: {
      primary: "anthropic/claude-haiku-4.5",
      fallback: ["anthropic/claude-opus-4.6"],
  ...
  // Time-windowed promotions — TokenBoss fork disables BlockRun's promos
  // since they target models we don't carry in our aggregator.
  promotions: [],
